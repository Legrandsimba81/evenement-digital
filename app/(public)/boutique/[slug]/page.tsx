// app/(public)/boutique/[slug]/page.tsx
...
export default async function BoutiquePage({ params }: { params: { slug: string } }) {
  try {
    ...
    const avgRating = shop.reviews && shop.reviews.length
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-3 text-sm text-gray-500 dark:text-gray-400 mt-1">
                  ...
                  <span className="flex items-center gap-1">
                    ...
                    {avgRating} ({shop.reviews?.length || 0} avis)
                  </span>
                </div>
              </div>
            </div>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Impossible de charger cette boutique.</p>
        </div>
      </div>
    );
  }
