...
export default async function InvitationPage({
    ...
    // ✅ Correction : typage explicite de g avec any
            ...
            <div className="min-h-screen flex items-center justify-center p-4 bg-gray-50 dark:bg-gray-950">
                <div className="max-w-md mx-auto p-8 bg-white dark:bg-gray-900 rounded-2xl shadow-xl text-center border border-gray-200 dark:border-gray-800">
                    ...
                    <p className="mt-4 text-gray-600 dark:text-gray-400">
                        Si c'est une erreur, contactez-nous sur WhatsApp ou réessayez.
                    </p>
                    <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
                        {event.whatsappNumber && (
                            <a
                                ...
                                target="_blank"
                                className="inline-flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-xl transition"
                            >
                        ...
                        <a
                            ...
                            className="inline-flex items-center justify-center gap-2 bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-xl transition"
                        >
                            Réessayer
                        </a>
                    </div>
    ...
    const messagesLove = event.messages.filter((m: any) =>
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-primary-500/5 to-secondary-500/5 py-12 px-4">
            <div className="max-w-3xl mx-auto">
                <InvitationCard event={event} guestName={guestName} guestTitle={guest?.title || undefined} />
