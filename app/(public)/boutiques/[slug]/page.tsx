...
import { Calendar, MapPin, Phone, Globe, Star, ArrowLeft, Check } from "lucide-react";
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl overflow-hidden border border-gray-100 dark:border-gray-800">
            ...
            <div className="relative w-full aspect-[21/9] bg-gradient-to-r from-blue-500 to-purple-500">
              ...
              {shop.isVerified && (
                <div className="absolute top-3 right-3 sm:top-4 sm:right-4 bg-blue-600 text-white rounded-full px-3 py-1 flex items-center gap-1.5 text-xs font-medium shadow-lg">
                  <Check size={14} className="stroke-white fill-white" />
                  Vérifié
                </div>
              )}
            </div>
            ...
            <div className="p-4 sm:p-6 md:p-8">
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 -mt-12 sm:-mt-14 relative z-10">
                <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl border-4 border-white dark:border-gray-900 shadow-lg bg-white dark:bg-gray-800 flex-shrink-0 overflow-hidden">
                  {shop.logo ? (
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap items-center gap-2 sm:gap-4 mt-1 text-xs sm:text-sm text-gray-500 dark:text-gray-400">
                    <span className="bg-primary-100 dark:bg-primary-900/30 text-primary-700 dark:text-primary-300 px-2 py-0.5 rounded-full">
