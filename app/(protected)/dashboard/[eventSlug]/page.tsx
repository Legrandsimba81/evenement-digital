    ...
    <div className="w-full">
      {isPast && (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4">
          <div className="bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-xl p-4 flex items-center gap-3 text-gray-700 dark:text-gray-300 text-sm">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-4">
        <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-medium ${planColor}`}>
          {planIcon}
          Plan : {planLabel}
        </div>
        {eventLimit !== null && eventLimit <= 5 && (
          <div className="mt-2 flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
            ...
            <p>
              Vous êtes sur le plan gratuit (5 invités maximum). Pour plus d'invités, consultez nos tarifs ou contactez l'équipe.
            </p>
          </div>
        )}
      </div>
