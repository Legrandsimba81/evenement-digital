            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 p-6">
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
                        ...
                        Abonnement <span className="text-primary-500">Octavia verified</span> – {shop.name}
                    </h1>
                    <p className="text-gray-600 dark:text-gray-300 mt-2">
                        {shop.isVerified
                            ? "Votre boutique est actuellement vérifiée. Gérez votre abonnement ci-dessous."
                            : "Souscrivez à un abonnement pour obtenir le badge bleu de vérification et débloquer des fonctionnalités exclusives."}
                    </p>
