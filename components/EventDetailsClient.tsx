            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                ...
                <div className="flex flex-wrap gap-3 mt-4 md:mt-0">
                    ...
                    {event.userId === session?.user?.id && (
                        <Link
                            href={`/dashboard/${event.slug}/admin`}
                    ...
                    <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-6">
                        ...
                        <div className="mt-4 flex flex-wrap gap-3">
                            <button
                                ...
                                className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-xl transition disabled:opacity-50"
                            >
                                <Download size={18} />
                                {isExporting ? "Téléchargement..." : "Télécharger (CSV)"}
                            </button>
                            <button
                                onClick={() => handleExport("pdf")}
                                disabled={isExporting}
                                className="inline-flex items-center gap-2 bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-xl transition disabled:opacity-50"
                            >
                                <Download size={18} />
                                {isExporting ? "Téléchargement..." : "Télécharger (PDF)"}
                            </button>
                        </div>
                    </div>
                </TabsContent>
